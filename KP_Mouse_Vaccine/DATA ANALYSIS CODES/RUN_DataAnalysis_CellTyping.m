...
InCell = 'Y:\sorger\data\RareCyte\';
basefolder = [InCell 'Claire\CCR-002-ImmuneVaccine\'];
...
CellType.Classes =  { ...
              {'Immune',           1, 1       ,{7,8,11,12}} ... 
             ,{'Epithelial',       1, 2       ,{6}}  ...
             ,{'Other',            1, 3       ,{[-6 -7 -8 -11 -12]}} ...
             ,{'Lymphoid',         2, 11      ,{7,11,12}}...
             ,{'Immune Other',     2, 12      ,{[-7 -11 -12]}}        ...
             ,{'T',                3, 111     ,{11,12}}     ... CD4+/CD8+
             ,{'B',                3, 112     ,{7}}               ... B220+
             ,{'T reg',            4, 1111    ,{[10 11],[10 12]}}             ... CD4+ FOXP3+
             ,{'T helper',         4, 1112    ,{[11 -10]}}         ... CD4+ FOXP3-
             ,{'T cytotox',        4, 1113    ,{[12 -10]}}           ... CD8+
              }; 
...
CellType.NvC = int16(ones(size(CellType.ABlist))); 
% CellType.NvC = int16(zeros(size(CellType.ABlist))); 
...
for i = 1:length(CellType.NvC)
    TypeData(:,CellType.ABlist(i)) = NormResults.MedianCytNorm(:,CellType.ABlist(i)).*CellType.NvC(i) + ...
                                     NormResults.MedianNucNorm(:,CellType.ABlist(i)).*(1-CellType.NvC(i));
end
...
ind_nospleen = ones( size(CellType.Matrix,1),1) ;%ROIResults.SpleenIndex == 0;
