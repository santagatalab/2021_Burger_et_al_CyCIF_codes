...
options.cellsize = 15;   % Estimated radius of cells in pixels
options.bkgdprob_min = 0.2;  % Thresh for backgorund Ilastik probability
options.cytprob_min  = 0.8;  % Thresh for backgorund Ilastik probability
options.nucprob_min  = 0.33;   % Thresh for backgorund Ilastik probability
...
%% clean up the crops to avoid emptry crops in Ilastik training - optional
