...
for i = 1:length(filename.tissues)
    ...
    if length(filename.ashlarsubfol) > 0
        omefold = [filename.folders.main filename.folders.ashlared ];
        omefile = [omefold filename.tissues{i} filesep filename.ashlarsubfol filename.tissues{i} '.ome.tif'];
    else
        omefold = [filename.folders.main filename.folders.ashlared ];
